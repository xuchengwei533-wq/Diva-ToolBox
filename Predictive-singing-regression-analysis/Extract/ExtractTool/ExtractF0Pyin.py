...
F0_out = os.path.join(output_root, "F0")
os.makedirs(F0_out, exist_ok=True)
...
def extract_f0(audio, sr, hop_length=512):
    f0, _, _ = librosa.pyin(
        audio,
