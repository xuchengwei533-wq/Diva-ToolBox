...
output_dir = os.path.join(output_root, "Train_Jitter")
...
if xs.size == 0:
    raise RuntimeError("没有可用样本，请确认 JitterOutput 已生成")
...
plt.tight_layout()
out_path = os.path.join(output_dir, "Jitter_median_by_score.png")
